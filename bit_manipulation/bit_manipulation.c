...
// >> Right Shift:  Each shift is a divided by 2 with round towards negative infinity
//
// x = 193;        /* 1100 0001 */ 
// y = x >> 2;    
// x == 48;        /* 0011 0000 */ 
...
int flip_bit(unsigned int x, int position){
  return x ^= 1UL << position;
}

int check_bit(unsigned int x, int position){
